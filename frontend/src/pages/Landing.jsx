  ...
  const features = [
    {
      ...
      title: "Fresh Daily",
      description:
        "Sourced directly from Japanese markets, ensuring peak freshness.",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Premium Quality",
      description:
        "Only the finest grade seafood and authentic Japanese ingredients.",
    },
    {
      icon: <Leaf className="w-8 h-8" />,
      title: "Sustainable",
      description:
        "Ethically sourced with respect for the ocean and tradition.",
    },
  ];
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-2xl mx-auto mb-8 leading-relaxed">
            Experience the authentic flavors of Japanese seafood and premium
      ...
      <section className="py-20 bg-accent text-accent-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">
            From sushi-grade fish to traditional seasonings, discover the
            ingredients that make Japanese cuisine exceptional.
          </p>
          <Link to="/contact">
            <Button
              size="lg"
